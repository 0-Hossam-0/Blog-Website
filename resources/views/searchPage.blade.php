...
@section('post')
    ...
    @foreach ($posts as $post)
        <div class="hidden">
            <div style="margin-top:5rem;" class="post-body">
        ...
        <div class="footer">
            <button>
                <a style="text-decoration: none;color:black;" href="./post/{{$post->post_id}}"><span class="comments-icon material-symbols-outlined">comment</span></a>
            </button>
    ...
    @else
    <h1 style="margin-left:40rem;margin-top:15rem;">No Posts Found!</h1>
    @endif
@endsection